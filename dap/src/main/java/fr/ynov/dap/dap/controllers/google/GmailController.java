...
public class GmailController {
	...
	final static Logger LOG = LogManager.getLogger(GmailController.class);
    ...
    public @ResponseBody String getNbrUnreadMail(@PathVariable String userKey) throws IOException, GeneralSecurityException, JSONException {
